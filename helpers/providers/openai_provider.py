"""
Proveedor OpenAI (fiel a la app Gradio original).

Que hace:
    Usa el cliente OpenAI con function calling nativo. Repite el ciclo:
    llamar al modelo -> si pide herramientas, ejecutarlas y reenviar los resultados ->
    hasta obtener la respuesta final de texto.
"""
